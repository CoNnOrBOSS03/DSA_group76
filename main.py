...
def main():
    # get data
    bridges = Bridges(209, "BRIDGES_USER_ID", "BRIDGES_API_KEY")

    bridges.set_title("Graph : OpenStreet Map Example")
    bridges.set_description(
        "OpenStreet Map data of Charlotte downtown area, with colors based on distance from the center of downtown")
